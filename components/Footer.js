  ...
  return (
    ...
    >
      <div className="section-container flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="text-xs text-center" style={{ color: 'var(--color-grey-dim)' }}>
          {t.footer.made} · © {year} {t.footer.rights}
        </p>
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            ...
            className="transition-colors duration-150 text-xs font-mono"
            style={{ color: 'var(--color-grey-dim)' }}
            onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--color-green)')}
            onMouseLeave={(e) => (e.currentTarget.style.color = 'var(--color-grey-dim)')}
          >
