const Socials = () => (
  <div className="w-full grid gap-5 sm:flex sm:justify-between sm:object-center">
    ...
    <div className="grid grid-flow-col content-evenly gap-6 sm:gap-8 lg:mr-7 z-50">
      <a href="https://github.com/anna-dominguez" target="_blank">
        <svg
          className="social"
      ...
      <a href="https://www.frontendmentor.io/profile/Vesta-nna" target="_blank">
        <svg
          className="social"
          xmlns="http://www.w3.org/2000/svg"
          width="26"
      ...
      <a href="https://www.linkedin.com/in/adomingu/" target="_blank">
        <svg
          className="social"
          xmlns="http://www.w3.org/2000/svg"
          width="25"
      ...
      <a href="https://twitter.com/vesta_nna" target="_blank">
        <svg
          className="social"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
